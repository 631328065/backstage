<template>
  <el-form ref="form" :rules="rules" :model="product" label-width="120px" style="width: 600px">
    <el-form-item label="商品分类：" prop="productCategoryId">
      <el-cascader v-model="product.productCategoryId" :options="catList" :props="{ label: 'name', value: 'id' }" @change="handleChangeCat"></el-cascader>
    </el-form-item>
    ...
    <el-form-item label="商品品牌：" prop="brandId">
      <el-select placeholder="请选择品牌" v-model="product.brandId" size="small" @change="handleChangeBrand">
        <el-option v-for="item in brandList" :label="item.name" :value="item.id" :key="item.id"></el-option>
      </el-select>
    </el-form-item>
    <el-form-item label="商品介绍：" prop="description">
      <el-input type="textarea" placeholder="请输入内容" v-model="product.description"></el-input>
    </el-form-item>
    ...
    <el-form-item label="商品重量：" prop="weight"> <el-input v-model="product.weight" size="small" style="width: 300px; margin-right: 10px"></el-input>克 </el-form-item>
